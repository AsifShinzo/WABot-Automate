...
> CONVERTER
❐ download, play, status, steal, sticker, toaudio
      
> FUN
❐ chatai, imgai, retrieve, tg_sticker, friendai
      
> GROUP ADMINS
❐ demote, promote, remove, gc, ping
      
> TEST
❐ test
      
> UTILITY
❐ info, menu, mods, reminder
      
> WEEB
❐ animerelease (working on more commands)
      
      
> ⚠ Note: Use /info <command_name> for more info on a specific command. Example: /info menu`
